...
**NA is there because there are entries for n_2021 that are not of dbl value. These have not been omitted from the set**
...
**There are multiple outliers in the data- it is skewed.**
